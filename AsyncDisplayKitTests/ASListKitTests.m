...
// Major issue: if the collection view isn't in a window and an update is submitted,
// IGListAdapterUpdater will skip diffing and just call -reloadData as an optimization.
